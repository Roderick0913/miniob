...
static const yytype_int16 yyrline[] =
{
     ...
     403,   411,   423,   438,   460,   470,   475,   486,   489,   492,
     495,   498,   502,   505,   513,   520,   532,   537,   548,   551,
     565,   568,   581,   584,   590,   593,   598,   605,   617,   629,
     641,   656,   657,   658,   659,   660,   661,   665,   678,   686,
     696,   697
};
#endif
...
#line 387 "yacc_sql.y"
      ...
      LOG_TRACE("yyval type=%d data=%d" , yyval.value->attr_type() , yyval.value->get_int());
      free(tmp);
    }
