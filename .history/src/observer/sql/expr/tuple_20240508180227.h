...
public:
  ...
  {
    LOG_TRACE("set_record record.data=%d" , )
    this->record_ = record;
  }
  ...
  RC cell_at(int index, Value &cell) const override
  {
    ...
    LOG_TRACE("index = %d ,type = %d len = %d data = %s %offset = %d" , index , field_meta->type() , field_meta->len() , this->record_->data() , field_meta->offset());
    cell.set_data(this->record_->data() + field_meta->offset(), field_meta->len());
    LOG_TRACE("date = %d" , cell.get_int());
    return RC::SUCCESS;
  }
